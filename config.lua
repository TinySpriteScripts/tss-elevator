Config = {
    ...
    UIPosition = 'left', --'left' / 'center' / 'right' (add more positions in html,script.js)

    UseElevatorSound = 'elevator',
    SoundVolume = 0.1, -- volume of elevator sound

    ElevatorLabel = "Use Elevator",
    Elevators = { --you must set up elevators for your server. i just provided a way to do that
